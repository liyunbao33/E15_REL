...
#define REL_IN_LAST_CHECK_m            ((uint8_T)2U)
  ...
  DW_FLDoorReleaseDriver_REL_T *localDW)
{
  ...
  } else if (localDW->is_MAIN_PROGRESS_p == REL_IN_IDLE) {
    *rty_SO_e_MotorMode = 0U;
    if ((localDW->SO_b_DoorRlsReq_prev != localDW->SO_b_DoorRlsReq_start) &&
        localDW->SO_b_DoorRlsReq_start) {
      localDW->is_MAIN_PROGRESS_p = REL_IN_RELEASE;
      localDW->SL_e_CheckCycle = 0U;
      *rty_SO_e_MotorPwm = 100U;
    ...
    switch (localDW->is_RELEASE_k) {
      ...
      *rty_SO_e_MotorMode = 2U;
      if (localDW->temporalCounter_i1 >= 30) {
        ...
        localDW->is_MAIN_PROGRESS_p = REL_IN_IDLE;
        *rty_SO_b_MotorA = false;
        *rty_SO_b_MotorB = false;
        *rty_SO_e_MotorMode = 0U;
        *rty_SO_e_MotorPwm = 0U;
     ...
     default:
      /* case IN_STEP2_OPEN: */
      if (localDW->is_STEP2_OPEN_j == REL_IN_IDLE) {
        *rty_SO_e_MotorMode = 0U;
        if ((localDW->temporalCounter_i1 < 270) && (!rtu_SI_b_DoorAjar)) {
          localDW->is_STEP2_OPEN_j = REL_IN_NO_ACTIVE_CHILD;
          localDW->is_RELEASE_k = REL_IN_RESET;
          localDW->temporalCounter_i1 = 0U;
          *rty_SO_b_MotorA = false;
          *rty_SO_b_MotorB = true;
          ...
          *rty_SO_e_MotorPwm = 70U;
          ...
          localDW->is_STEP2_OPEN_j = REL_IN_LAST_CHECK_m;
        }
      } else {
        /* case IN_LAST_CHECK: */
        localDW->is_STEP2_OPEN_j = REL_IN_NO_ACTIVE_CHILD;
 ...
 *    '<S3>/RRDoorReleaseDriver'
 */
void REL_FLDoorReleaseDriver(boolean_T rtu_SO_b_DoorRlsReq, Boolean
  ...
  DW_FLDoorReleaseDriver_REL_T *localDW)
{
  ...
  if (localDW->is_active_c19_DoorReleaseDriver == 0U) {
    localDW->SO_b_DoorRlsReq_prev = rtu_SO_b_DoorRlsReq;
    localDW->SI_b_CinchHome_prev = rtu_SI_b_CinchHome;
    localDW->is_active_c19_DoorReleaseDriver = 1U;
    localDW->is_c19_DoorReleaseDriver = REL_IN_STARTUP_SETTING;
    localDW->temporalCounter_i1 = 0U;
    *rty_SO_b_MotorA = false;
    *rty_SO_b_MotorB = true;
    *rty_SO_e_MotorMode = 2U;
    *rty_SO_e_MotorPwm = 100U;
  } else if (localDW->is_c19_DoorReleaseDriver == REL_IN_NORMAL) {
    ...
    *rty_SO_e_MotorMode = 2U;
    if (localDW->temporalCounter_i1 >= 30) {
      localDW->is_c19_DoorReleaseDriver = REL_IN_NORMAL;
...
void REL_Step(void)                    /* Explicit Task: REL_Step */
{
  ...
  REL_FLDoorReleaseDriver(REL_Y.VbOUT_REL_FLDoorRlsReq_flg_VbOU,
    ...
    &REL_Y.VeOUT_REL_FLDoorMotorSts_sig_Ve, &SI_b_DoorInSwSts_prev_d,
    &SI_e_DoorLockSet_prev, &REL_DW.sf_FLDoorReleaseDriver);
  ...
  REL_FLDoorReleaseDriver(REL_Y.VbOUT_REL_FRDoorRlsReq_flg_VbOU,
    ...
    &SI_e_DoorLockSet_prev, &REL_DW.sf_FRDoorReleaseDriver);
  ...
  REL_FLDoorReleaseDriver(REL_Y.VbOUT_REL_RLDoorRlsReq_flg_VbOU,
    ...
    &SI_e_DoorLockSet_prev, &REL_DW.sf_RLDoorReleaseDriver);

  /* Chart: '<S3>/RRDoorReleaseDriver' incorporates:
  ...
  REL_FLDoorReleaseDriver(REL_Y.VbOUT_REL_RRDoorRlsReq_flg_VbOU,
    ...
    &SI_e_DoorLockSet_prev, &REL_DW.sf_RRDoorReleaseDriver);
...
{
  {
    ...
    REL_FLDoorReleaseDriver_Init(&REL_Y.VbOUT_REL_FLDoorMotorA_flg_VbOU,
      &REL_Y.VbOUT_REL_FLDoorMotorB_flg_VbOU,
      &REL_Y.VeOUT_REL_FLDoorMotorSts_sig_Ve, &SO_b_Error_l, &SO_e_MotorPwm_h);
    ...
    REL_FLDoorReleaseDriver_Init(&REL_Y.VbOUT_REL_FRDoorMotorA_flg_VbOU,
      &REL_Y.VbOUT_REL_FRDoorMotorB_flg_VbOU,
      &REL_Y.VeOUT_REL_FRDoorMotorSts_sig_Ve, &SO_b_Error_l, &SO_e_MotorPwm_h);
    ...
    REL_FLDoorReleaseDriver_Init(&REL_Y.VbOUT_REL_RLDoorMotorA_flg_VbOU,
      &REL_Y.VbOUT_REL_RLDoorMotorB_flg_VbOU,
      &REL_Y.VeOUT_REL_RLDoorMotorSts_sig_Ve, &SO_b_Error_l, &SO_e_MotorPwm_h);
    ...
    /* SystemInitialize for Chart: '<S3>/RRDoorReleaseDriver' incorporates:
     *  Outport: '<Root>/VbOUT_REL_RRDoorMotorA_flg_VbOUT_REL_RRDoorMotorA_flg'
     *  Outport: '<Root>/VbOUT_REL_RRDoorMotorB_flg_VbOUT_REL_RRDoorMotorB_flg'
     *  Outport: '<Root>/VeOUT_REL_RRDoorMotorSts_sig_VeOUT_REL_RRDoorMotorSts_sig'
     */
    REL_FLDoorReleaseDriver_Init(&REL_Y.VbOUT_REL_RRDoorMotorA_flg_VbOU,
      &REL_Y.VbOUT_REL_RRDoorMotorB_flg_VbOU,
      &REL_Y.VeOUT_REL_RRDoorMotorSts_sig_Ve, &SO_b_Error_l, &SO_e_MotorPwm_h);
