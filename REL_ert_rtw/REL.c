...
void REL_RLDoorRlsReq(boolean_T rtu_SI_b_OFF, UInt8 rtu_SI_e_EspVehSpd, Boolean
                      ...
                      rtu_SI_b_DoorHndBtnSts, UInt8 rtu_SI_e_DoorHandPosSts,
                      Boolean rtu_SI_b_CentSingleDoorBtnSts, Boolean
