...
static void REL_NORMAL(const boolean_T *SI_b_DCUCinchHomeSwt_prev, const
  boolean_T *SO_b_DoorRlsReq_prev);
...
void REL_Step(void)                    /* Explicit Task: REL_Step */
{
  ...
  SI_b_DoorInSwSts_prev_d = REL_DW.SI_b_DCUCinchHomeSwt_start;
