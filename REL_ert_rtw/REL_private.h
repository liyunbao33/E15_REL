...
extern void REL_RLDoorRlsReq(UInt8 rtu_SI_e_EspVehSpd, Boolean
  rtu_SI_b_EspVehSpdVld, UInt8 rtu_SI_e_VcuGearPosn, UInt8 rtu_SI_e_DoorLockSts,
  uint8_T rtu_SI_e_DoorRatSts, boolean_T rtu_SI_b_DoorInBtnSts, boolean_T
  rtu_SI_b_DoorHndBtnSts, Boolean rtu_SI_b_ChildLckSts, boolean_T
